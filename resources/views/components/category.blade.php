...
<div {{ $attributes->merge(['class' => 'flex flex-col items-center w-[140px] md:w-full md:items-baseline text-lg gap-3 p-5 border border-gray-300 bg-white hover:border-blue-800 rounded group cursor-pointer']) }}>
