@php
$candidate_name = $interview->application->seeker->first_name . ' ' . $interview->application->seeker->last_name;
$jobTitle = $interview->application->career->title;
@endphp
    ...
    <div class="bg-gray-50 flex items-center justify-center p-6">
        <div class="w-full max-w-៦xl bg-white rounded-xl shadow-md border border-gray-100 p-8">
            ...
            <div class="mb-8 border-b border-gray-100 pb-4">
                <h2 class="text-2xl font-bold text-gray-800"> Interview Reschedule</h2>
            ...
            <form action="{{ route('employer.interview.update', ['interview'=>$interview]) }}" method="post" class="space-y-6">
                @csrf @method('PATCH')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            id="interview_date"
                            name="interview_date"
                            value="{{ $interview->interview_date? $interview->interview_date:old('interview_date')}}"
                            required
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="interview_time"
                            name="interview_time"
                            value="{{ $interview->interview_time ? $interview->interview_time:old('interview_time') }}"
                            required
                            class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors outline-none text-gray-800">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        id="location"
                        name="location"
                        value="{{ $interview->location ? $interview->location : old('location') }}"
                        class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors outline-none text-gray-800 placeholder-gray-400"
                ...
                <div>
                    ...
                    <input
                        ...
                        id="meeting_link"
                        name="meeting_link"
                        value="{{ $interview->meeting_link ? $interview->meeting_link : old('meeting_link') }}"
                        class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors outline-none text-gray-800 placeholder-gray-400"
                ...
                <div class="flex items-center justify-end space-x-4 pt-4 border-t border-gray-100 mt-8">
                    <a
                        href="{{ route('employer.interviews') }}"
