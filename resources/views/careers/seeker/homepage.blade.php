<x-master-layout>
    ...
    <section class="md:hidden p-5 flex flex-col gap-3">
        ...
        <span class="text-description">Connecting high-level talent with Cambodia's leading enterprises.</span>
    ...
    <section class="p-5 md:px-20 pt-15 flex flex-col gap-2 bg-[#F4F5F7]">
        ...
        <div class="outer-container w-full overflow-x-scroll md:overflow-hidden">
            <div class="w-[600px] md:w-full flex md:grid grid-cols-4 gap-4 mt-4">
                @foreach ($categories as $category)
                <x-category :badge="$category->icon" :category_name="$category->category_name" :jobs_count="$category->careers->count()" />
                @endforeach
            </div>
        </div>
    </section>
    <section class="px-5 pt-5 md:px-20 md:pt-20 flex flex-col gap-6 bg-[#F4F5F7]">
        <div class="flex flex-col gap-2 justify-center items-baseline md:items-center">
            ...
            <span class="text-[18px] text-gray-600">Top-tier positions from leading organizations</span>
        </div>
    ...
    <section class="p-5 md:p-0">
        <div class="bg-gray-800 px-5 py-10 rounded md:p-0 md:rounded-none md:bg-blue-900 md:h-[300px] w-full flex flex-col gap-4 justify-center items-center">
            ...
            <span class="md:w-1/2 text-gray-300 text-lg text-center">Upload your CV to be seen by HR and increase your chance of getting hired.</span>
