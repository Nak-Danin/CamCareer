<x-master-layout>
    <div class="w-full min-h-screen mx-auto px-5 md:px-10 py-8">
        <div class="grid grid-cols-1 md:grid-cols-[380px_1fr] gap-8">
            {{-- ===================== FILTER SIDEBAR ===================== --}}
            <aside class="bg-white border border-gray-200 rounded-xl p-5 h-fit">
                ...
                <form action="{{ route('seeker.filterJobs') }}" method="GET" class="space-y-6">
